...
SECRET_KEY = 'django-insecure-kt%lpu9*)+=-$p0ih#h89z-@h=#p-(w88l8++4s8f7(cgp*9+$'
...
DATABASES = {
    "default": {
        ...
        "NAME": "doctor_patient_db",  # your DB name
        "USER": "root",
        "PASSWORD": "Password@1",  # replace with your real password
        "HOST": "127.0.0.1",
        "PORT": "3306",
        "OPTIONS": {
